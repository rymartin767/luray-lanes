        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link wire:navigate.hover href="{{ route('specials') }}" :active="request()->routeIs('specials')">
                        {{ __('Specials') }}
                    </x-nav-link>
                    <x-nav-link wire:navigate.hover href="{{ route('food') }}" :active="request()->routeIs('food')">
                        {{ __('Food & Bar') }}
                    </x-nav-link>
                    <x-nav-link wire:navigate.hover href="{{ route('contact') }}" :active="request()->routeIs('contact')">
                        {{ __('Contact Us') }}
                    </x-nav-link>
                </div>
            </div>
