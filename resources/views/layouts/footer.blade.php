    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                <li>
                    <a href="/reservations" wire:navigate class="mr-4 hover:underline md:mr-6 ">Reserve A Lane</a>
                </li>
                <li>
                    <a href="/birthdays" wire:navigate class="mr-4 hover:underline md:mr-6">Birthdays</a>
                </li>
                <li>
                    <a href="/specials" wire:navigate class="mr-4 hover:underline md:mr-6 ">Specials</a>
                </li>
                <li>
                    <a href="/food" wire:navigate class="mr-4 hover:underline md:mr-6 ">Food & Bar</a>
                </li>
                <li>
