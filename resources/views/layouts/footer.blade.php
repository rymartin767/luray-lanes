<footer class="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black dark:from-black dark:via-gray-900 dark:to-gray-800 overflow-hidden">
    <!-- Decorative Background Elements -->
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <!-- Gradient Orbs -->
        <div class="absolute -top-24 -left-24 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl"></div>
        <div class="absolute -bottom-24 -right-24 w-96 h-96 bg-orange-600/10 rounded-full blur-3xl"></div>

        <!-- Decorative Lines -->
        <div class="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-orange-500/20 to-transparent"></div>
        <div class="absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-orange-500/10 to-transparent"></div>
    </div>

    <div class="relative w-full max-w-screen-xl mx-auto p-8 lg:py-12">
        <!-- Top Section -->
        <div class="sm:flex sm:items-center sm:justify-between mb-12">
            <a href="/" class="flex items-center mb-6 sm:mb-0 group">
                <div class="relative">
                    <div class="absolute inset-0 bg-orange-500/20 rounded-xl blur-lg group-hover:bg-orange-500/30 transition-all duration-300"></div>
                    <img src="{{ asset('site-images/logo.jpg') }}" alt="" class="relative h-16 w-16 mr-4 rounded-xl shadow-xl transform group-hover:scale-105 transition-transform duration-300">
                </div>
                <span class="self-center text-3xl font-alex font-bold bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent">Luray Lanes</span>
            </a>
            <ul class="flex flex-col lg:flex-row space-y-3 lg:space-y-0 lg:space-x-8 items-center text-base font-alex font-medium">
                <li>
                    <a href="/birthdays" wire:navigate class="text-gray-300 hover:text-orange-400 transition-colors duration-200 relative group">
                        Birthdays
                        <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-orange-400 to-orange-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                </li>
                <li>
                    <a href="/specials" wire:navigate class="text-gray-300 hover:text-orange-400 transition-colors duration-200 relative group">
                        Specials
                        <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-orange-400 to-orange-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                </li>
                <li>
                    <a href="/food" wire:navigate class="text-gray-300 hover:text-orange-400 transition-colors duration-200 relative group">
                        Food & Bar
                        <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-orange-400 to-orange-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                </li>
                <li>
                    <a href="/contact" wire:navigate class="text-gray-300 hover:text-orange-400 transition-colors duration-200 relative group">
                        Contact Us
                        <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-orange-400 to-orange-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                </li>
        ...
        <div class="relative h-px mb-8">
            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-orange-500/50 to-transparent"></div>
        </div>

        <!-- Bottom Section -->
        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
            <!-- Copyright with Cardinal -->
            <div class="flex flex-row items-center justify-center lg:justify-start gap-2 bg-white/5 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/10">
                <div class="text-sm text-gray-300 font-medium">
                    © {{ now()->format('Y')}} Luray Lanes. All Rights Reserved
                </div>
                <div class="relative group">
                    <div class="absolute inset-0 bg-red-500/20 rounded-full blur-md group-hover:bg-red-500/30 transition-all duration-300"></div>
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="1421.333" height="1706.667" viewBox="0 0 1066 1280" class="relative h-7 w-7 fill-current text-red-600 transform group-hover:scale-110 transition-transform duration-300 drop-shadow-lg">
            ...
            <!-- Designed By -->
            <div class="flex flex-row items-center gap-2 mx-auto lg:mx-0 bg-white/5 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/10">
                <div class="text-sm text-gray-300">Designed with</div>
                <div class="relative">
                    <div class="absolute inset-0 bg-red-500/20 rounded-full blur-sm"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="relative fill-current text-red-500 h-3.5 w-3.5 animate-pulse">
                ...
                <div class="text-sm text-gray-300 font-medium">by NT4C Labs, LLC</div>
            </div>
        </div>
    </div>
</footer>